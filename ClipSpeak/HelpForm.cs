...
internal sealed class HelpForm : Form
{
    ...
    private static string BuildHelpText(AppSettings settings)
    {
        return string.Join(Environment.NewLine, [
            ...
            "Select text in the focused app, then press the Read selected text hotkey. ClipSpeak reads the selection aloud without changing the clipboard.",
            "",
            "Mouse popup",
            ...
            "",
            "If selected text is unavailable",
            "Some apps do not expose selected text to Windows UI Automation or run with higher privileges than ClipSpeak. If that happens, ClipSpeak shows a tray notice and does not read old clipboard text by mistake.",
            "",
            "Configuring hotkeys",
